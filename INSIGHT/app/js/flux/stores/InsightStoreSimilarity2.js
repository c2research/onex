...
var InsightStoreSimilarity = assign({}, {
  ...
  fillqueryNameListDataset: function() {
    queryListViewData.queryNameListDataset = [];
    for (var i = 0; i < InsightStore.getDSCurrentSize(); i++) {
        queryListViewData.queryNameListDataset.push("Dataset: sequence " + i);
    }
  ...
  requestQuery: function() {
    ...
    var queryName = fromDataset ? queryListViewData.queryNameListDataset[selectedQuery] :
